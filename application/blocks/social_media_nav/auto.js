Concrete.event.bind('btSocialMediaNav.socialLinks.edit.open', function (options, settings) {
    ...
    var updateItem = function (newField) {
        ...
        $.each($(newField).find('.ft-smart-link'), function () {
            var ftSmartLinkImage = $(this).find('.ft-smart-link-socialLinks-socialLink-image-selector');
            ...
            var ftSmartLinkFile = $(this).find('.ft-smart-link-socialLinks-socialLink-file-selector');
            ...
            var ftSmartLinkPage = $(this).find('.ft-smart-link-socialLinks-socialLink-page-selector');
