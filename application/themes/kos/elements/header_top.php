...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="<?php echo $view->getThemePath() ?>/assets/libs/lenis/lenis.css?v=<?php echo time(); ?>">
  ...
  ?>
      <link rel="stylesheet" type="text/css" href="<?php echo $view->getThemePath() ?>/assets/css/pages/<?php echo PAGETEMPLATE; ?>.css?v=<?php echo time(); ?>">
  <?php
    }
  }
