...
window.addEventListener('load', () => {
  ...
  const contactEndpoint = window.INFINITY_PLAY?.apiContactUrl || '/api/contact';
  ...
  if (contactForm) {
    contactForm.addEventListener('submit', async (event) => {
      ...
      try {
        ...
        setContactStatus('error', error.message || 'Unable to send your message right now.');
      } finally {
        ...
        if (contactSubmit) {
          ...
          if (contactSubmitLabel) {
            ...
            contactSubmit.textContent = defaultSubmitLabel;
          }
        }
      }
    });
...
//         },
//         load: function () {
//           var ele = document.getElementById('cookie-modal');
//           console.log('ele', ele)
//           if (ele) {
//             var modal = new bootstrap.Modal(ele, {
//               keyboard: false
//             });
//             console.log('modal', modal)
//             // if (!$('body').hasClass('edit') && ele) {
//             //   let isAccept = Cookies.get('isAccept');
//             //   if (!isAccept) {
//             //     modal.show();
//             //     $(ele).find('.btn--cancel').click(function () {
//             //       Cookies.set("isAccept", "NO", { expires: 7 });
//             //       modal.hide();
//             //     });
//             //     $(ele).find('.btn--accept').click(function () {
//             //       Cookies.set("isAccept", "YES", { expires: 7 });
//             //       modal.hide();
//             //     });
//             //   }
//             // }
...
//       $('.mobile--navbar .btn--hamburger').click(function () {
//         $('body').addClass('menu-active');
//       });

//       $('.header--navigation .btn--primary.login').click(function () {
//         $('body').addClass('account-action login-action');
//       });

//       $('.header--navigation .btn--primary.register').click(function () {
//         $('body').addClass('account-action register-action');
//       });

//       $('.header--navigation .btn--close').click(function () {
//         $('body').removeClass('menu-active');
//       });

//       $('.header--account .btn--close').click(function () {
//         $('body').removeClass('account-action login-action register-action');
//       });
//     },
//     enllax: function () {
//       if (!vm.isEdit) $("*[data-enllax-type]").length && $(window).width() > 767 && $(window).enllax();
//     },
//     headerNavToggle: function () {
//       $(".nav-page-select").click(function () {
//         $(".left-nav-container").toggleClass("active");
//         $(".header-page-list").toggleClass("active");
//       });
//     },
//     headerNavBgClick: function () {
//       $(".nav-background").click(function () {
//         var checkNavContainer = $(".left-nav-container");
//         var checkHeaderPageList = $(".header-page-list");

//         if(checkNavContainer.hasClass("active")){
//           checkNavContainer.removeClass("active");
//           checkHeaderPageList.removeClass("active");
//         }
//       });
//     },
//   };
