...
<div id="formblock<?php echo $bID; ?>" class="ccm-block-type-form contact-form-template">
    ...
    >
        ...
        <div class="contact-form-template__actions">
            <button type="submit" name="Submit" value="<?php echo h(t($survey->submitText)); ?>" class="contact-form-template__submit contact__submit btn btn--block">
                <svg class="contact-form-template__submit-cap contact__submit-cap btn__cap btn__cap--left" width="17" height="38" viewBox="0 0 17 38" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
                ...
                <span class="contact-form-template__submit-label contact__submit-label btn__label"><?php echo h(t($survey->submitText)); ?></span>
                <svg class="contact-form-template__submit-cap contact__submit-cap btn__cap btn__cap--right" width="17" height="38" viewBox="0 0 17 38" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" focusable="false">
